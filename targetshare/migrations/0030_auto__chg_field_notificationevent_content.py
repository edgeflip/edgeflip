...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NotificationEvent.content'
        db.alter_column('notification_events', 'content', self.gf('django.db.models.fields.CharField')(max_length=1028))

    def backwards(self, orm):

        # Changing field 'NotificationEvent.content'
        db.alter_column('notification_events', 'content', self.gf('django.db.models.fields.CharField')(max_length=128))
