...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterFeature.client'
        db.add_column('filter_features', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='filterfeatures', null=True, to=orm['targetshare.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilterFeature.client'
        db.delete_column('filter_features', 'client_id')
    ...
    models = {
        ...
        'targetshare.filterfeature': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filterfeatures'", 'null': 'True', 'to': "orm['targetshare.Client']"}),
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
