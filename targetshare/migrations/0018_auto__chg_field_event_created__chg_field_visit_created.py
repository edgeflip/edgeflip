...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Visit.created'
        db.alter_column('visits', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Event.created'
        db.alter_column('events', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Visit.created'
        db.alter_column('visits', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
