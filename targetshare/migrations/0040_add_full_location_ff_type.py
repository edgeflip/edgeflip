...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        matching = orm.FilterFeatureType.objects.get(code='matching')
        orm.FilterFeatureType.objects.create(
            name='Full Location',
            code='full_location',
            sort_order=matching.sort_order,
        )
        matching.sort_order += 1
        matching.save()
    ...
    def backwards(self, orm):
        ...
        matching.sort_order -= 1
        matching.save()
        orm.FilterFeatureType.objects.filter(code='full_location').delete()
