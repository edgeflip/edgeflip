...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CampaignProperties.client_content'
        db.alter_column('campaign_properties', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(db_column='content_id', to=orm['targetshare.ClientContent']))

    def backwards(self, orm):

        # Changing field 'CampaignProperties.client_content'
        db.alter_column('campaign_properties', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column='content_id', to=orm['targetshare.ClientContent']))
    ...
    models = {
        ...
        'targetshare.campaignproperties': {
            ...
            'client_content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'campaignproperties'", 'db_column': "'content_id'", 'to': "orm['targetshare.ClientContent']"}),
