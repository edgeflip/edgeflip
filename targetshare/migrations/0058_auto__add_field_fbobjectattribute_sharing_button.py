...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FBObjectAttribute.sharing_button'
        db.add_column('fb_object_attributes', 'sharing_button',
                      self.gf('django.db.models.fields.CharField')(default='Show Your Support', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FBObjectAttribute.sharing_button'
        db.delete_column('fb_object_attributes', 'sharing_button')
