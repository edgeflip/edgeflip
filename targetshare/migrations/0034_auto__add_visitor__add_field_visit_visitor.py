...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('visitors', (
            ('visitor_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('fbid', self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('targetshare', ['Visitor'])

        # Adding field 'Visit.visitor'
        db.add_column('visits', 'visitor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.Visitor'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Visit.visitor'
        db.delete_column('visits', 'visitor_id')
    ...
    models = {
        ...
        'targetshare.visit': {
            ...
            'visitor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['targetshare.Visitor']", 'null': 'True'})
        },
        'targetshare.visitor': {
