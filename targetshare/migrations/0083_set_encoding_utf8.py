...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        """Change character set and collation of Event.content field to support UTF-8."""
        db.execute("ALTER TABLE edgeflip.events MODIFY COLUMN content VARCHAR(1028) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL")

    def backwards(self, orm):
        """Revert character set and collation of Event.content field from support for UTF-8."""
        db.execute("ALTER TABLE edgeflip.events MODIFY COLUMN content VARCHAR(1028) NOT NULL")
