...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\"></div><div>Facebook Post</div><div>Finally, you'll create the Facebook post that your target audience will see. Clicking on this post will send users to your campaign content.</div></div></div>";
  return buffer;
  })
