...
class Migration(SchemaMigration):
    """Clean up Event fields moved to Visit and make Event.visit field required."""

    def forwards(self, orm):
        # Deleting field 'Event.ip'
        db.delete_column('events', 'ip')

        # Deleting field 'Event.app_id'
        db.delete_column('events', 'appid')

        # Deleting field 'Event.fbid'
        db.delete_column('events', 'fbid')

        # Deleting field 'Event.session_id'
        db.delete_column('events', 'session_id')

        # Changing field 'Event.visit'
        db.alter_column('events', 'visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.Visit']))

    def backwards(self, orm):
        # Adding field 'Event.ip'
        db.add_column('events', 'ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Event.app_id'
        db.add_column('events', 'app_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='appid', blank=True),
                      keep_default=False)

        # Adding field 'Event.fbid'
        db.add_column('events', 'fbid',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.session_id'
        db.add_column('events', 'session_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128),
                      keep_default=False)

        # Changing field 'Event.visit'
        db.alter_column('events', 'visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.Visit'], null=True))
    ...
    models = {
        ...
        'targetshare.event': {
            ...
            'visit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['targetshare.Visit']"})
        },
