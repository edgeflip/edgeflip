...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RankingFeatureType'
        db.create_table('ranking_feature_types', (
        ...
        db.send_create_signal('targetshare', ['RankingFeatureType'])

        # Adding field 'RankingKeyFeature.feature_type'
        db.add_column('ranking_key_features', 'feature_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.RankingFeatureType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RankingFeatureType'
        db.delete_table('ranking_feature_types')

        # Deleting field 'RankingKeyFeature.feature_type'
        db.delete_column('ranking_key_features', 'feature_type_id')
    ...
    models = {
        ...
        'targetshare.rankingkeyfeature': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'feature': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'feature_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['targetshare.RankingFeatureType']", 'null': 'True'}),
