...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignFBObject.source_url'
        db.add_column('campaign_fb_objects', 'source_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CampaignFBObject.sourced'
        db.add_column('campaign_fb_objects', 'sourced',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'CampaignFBObject', fields ['campaign', 'source_url']
        db.create_unique('campaign_fb_objects', ['campaign_id', 'source_url'])

    def backwards(self, orm):
        # Removing unique constraint on 'CampaignFBObject', fields ['campaign', 'source_url']
        db.delete_unique('campaign_fb_objects', ['campaign_id', 'source_url'])

        # Deleting field 'CampaignFBObject.source_url'
        db.delete_column('campaign_fb_objects', 'source_url')

        # Deleting field 'CampaignFBObject.sourced'
        db.delete_column('campaign_fb_objects', 'sourced')
