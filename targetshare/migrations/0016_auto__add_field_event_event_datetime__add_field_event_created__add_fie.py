...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.event_datetime'
        db.add_column('events', 'event_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Event.created'
        db.add_column('events', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visit.created'
        db.add_column('visits', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.event_datetime'
        db.delete_column('events', 'event_datetime')

        # Deleting field 'Event.created'
        db.delete_column('events', 'created')

        # Deleting field 'Visit.created'
        db.delete_column('visits', 'created')
