...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RankingKeyFeature.feature_type'
        db.alter_column('ranking_key_features', 'feature_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.RankingFeatureType']))

    def backwards(self, orm):

        # Changing field 'RankingKeyFeature.feature_type'
        db.alter_column('ranking_key_features', 'feature_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.RankingFeatureType'], null=True))
