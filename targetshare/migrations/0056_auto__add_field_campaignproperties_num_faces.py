...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignProperties.num_faces'
        db.add_column('campaign_properties', 'num_faces',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampaignProperties.num_faces'
        db.delete_column('campaign_properties', 'num_faces')
