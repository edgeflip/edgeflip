...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RankingKeyFeature'
        db.create_table('ranking_key_features', (
            ('ranking_key_feature_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ranking_key', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rankingkeyfeatures', null=True, to=orm['targetshare.RankingKey'])),
            ('feature', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('global_maximum', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('reverse', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ordinal_position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ...
        db.send_create_signal('targetshare', ['RankingKeyFeature'])

        # Adding unique constraint on 'RankingKeyFeature', fields ['ranking_key', 'ordinal_position']
        db.create_unique('ranking_key_features', ['ranking_key_id', 'ordinal_position'])

        # Adding model 'CampaignRankingKey'
        db.create_table('campaign_ranking_keys', (
            ('campaign_ranking_key_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='campaignrankingkeys', null=True, to=orm['targetshare.Campaign'])),
            ('ranking_key', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.RankingKey'], null=True, blank=True)),
            ('start_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('end_dt', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('targetshare', ['CampaignRankingKey'])

        # Adding model 'RankingKey'
        db.create_table('ranking_keys', (
            ('ranking_key_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rankingkeys', null=True, to=orm['targetshare.Client'])),
            ...
            ('refinement_weight', self.gf('django.db.models.fields.FloatField')(default=0.5, blank=True)),
        ...
        db.send_create_signal('targetshare', ['RankingKey'])


    def backwards(self, orm):
        # Removing unique constraint on 'RankingKeyFeature', fields ['ranking_key', 'ordinal_position']
        db.delete_unique('ranking_key_features', ['ranking_key_id', 'ordinal_position'])

        # Deleting model 'RankingKeyFeature'
        db.delete_table('ranking_key_features')

        # Deleting model 'CampaignRankingKey'
        db.delete_table('campaign_ranking_keys')

        # Deleting model 'RankingKey'
        db.delete_table('ranking_keys')
    ...
    models = {
        ...
        'targetshare.campaignrankingkey': {
            ...
            'end_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'ranking_key': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['targetshare.RankingKey']", 'null': 'True', 'blank': 'True'}),
            'start_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
