...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignProperties.inactive_url'
        db.add_column('campaign_properties', 'inactive_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2096, blank=True),
                      keep_default=False)

        # Adding field 'Client.campaign_inactive_url'
        db.add_column('clients', 'campaign_inactive_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2096),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampaignProperties.inactive_url'
        db.delete_column('campaign_properties', 'inactive_url')

        # Deleting field 'Client.campaign_inactive_url'
        db.delete_column('clients', 'campaign_inactive_url')
