...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FBObjectAttribute.sharing_button'
        db.alter_column('fb_object_attributes', 'sharing_button', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'FBObjectAttribute.sharing_button'
        db.alter_column('fb_object_attributes', 'sharing_button', self.gf('django.db.models.fields.CharField')(max_length=100))
