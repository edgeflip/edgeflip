...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Best guess for true event_datetime and created fields for Event and
        # Visit is current value of updated:
        orm.Event.objects.update(event_datetime=models.F('updated'))
        orm.Event.objects.update(created=models.F('updated'))

        orm.Visit.objects.update(created=models.F('updated'))

    def backwards(self, orm):
        # Revert created field to null, but don't bother with changed event_datetime
        orm.Visit.objects.update(created=None)
        orm.Event.objects.update(created=None)
