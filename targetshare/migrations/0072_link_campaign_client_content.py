...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampaignProperties.client_content'
        db.add_column('campaign_properties', 'client_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='campaignproperties', null=True, db_column='content_id', to=orm['targetshare.ClientContent']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CampaignProperties.client_content'
        db.delete_column('campaign_properties', 'content_id')
