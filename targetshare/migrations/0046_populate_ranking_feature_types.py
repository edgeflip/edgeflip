...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        topics = orm.RankingFeatureType.objects.create(name='Topics', code='topics')
        affected = orm.RankingKeyFeature.objects.update(feature_type=topics)
        if affected:
            print('Set feature type to "topics" for {} rows'.format(affected))

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.RankingKeyFeature.objects.update(feature_type=None)
        orm.RankingFeatureType.objects.filter(code='topics').delete()
