...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field auth_groups on 'Client'
        m2m_table_name = db.shorten_name('clients_auth_groups')
    ...
    def backwards(self, orm):
        # Removing M2M table for field auth_groups on 'Client'
        db.delete_table(db.shorten_name('clients_auth_groups'))
