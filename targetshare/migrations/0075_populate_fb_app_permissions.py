...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Populate Facebook permission codes."""
        permissions = [orm.FBPermission.objects.create(code=permission)
                       for permission in FB_PERMS_LIST]
        for client in orm.Client.objects.iterator():
            client.fb_app_permissions = permissions

    def backwards(self, orm):
        """Clear all Facebook permissions from table."""
        orm.FBPermission.objects.all().delete()
