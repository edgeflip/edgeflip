...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pages', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('page_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('code', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('targetshare', ['Page'])

        # Adding model 'CampaignPageStyleSet'
        db.create_table('campaign_page_style_sets', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('campaign_page_style_set_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(related_name='campaignpagestylesets', to=orm['targetshare.Campaign'])),
            ('page_style_set', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['targetshare.PageStyleSet'], unique=True)),
        ...
        db.create_table('page_styles', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('page_style_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Adding unique constraint on 'PageStyle', fields ['name', 'client']
        db.create_unique('page_styles', ['name', 'client_id'])
