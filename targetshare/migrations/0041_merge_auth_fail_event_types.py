...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Make oauth_declined events auth_fail events."""
        orm.Event.objects.filter(event_type='oauth_declined').update(
            event_type='auth_fail',
            content='oauth',
        )

    def backwards(self, orm):
        """Re-differentiate oauth failures from others."""
        orm.Event.objects.filter(event_type='auth_fail', content='oauth').update(
