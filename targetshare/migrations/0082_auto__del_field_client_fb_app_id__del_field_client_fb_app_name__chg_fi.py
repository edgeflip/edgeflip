...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        """Clean up old, non-normalized Facebook app data."""
        # Deleting field 'Client.fb_app_id'
        db.delete_column('clients', '_fb_app_id')

        # Deleting field 'Client.fb_app_name'
        db.delete_column('clients', 'fb_app_name')

        # Removing M2M table for field fb_app_permissions on 'Client'
        db.delete_table(db.shorten_name('clients_fb_app_permissions'))

        # Changing field 'Client.fb_app'
        db.alter_column('clients', 'fb_app_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.FBApp']))

    def backwards(self, orm):
        # Adding field 'Client.fb_app_id'
        db.add_column('clients', 'fb_app_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='_fb_app_id', blank=True),
                      keep_default=False)

        # Adding field 'Client.fb_app_name'
        db.add_column('clients', 'fb_app_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding M2M table for field fb_app_permissions on 'Client'
        m2m_table_name = db.shorten_name('clients_fb_app_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('client', models.ForeignKey(orm['targetshare.client'], null=False)),
            ('fbpermission', models.ForeignKey(orm['targetshare.fbpermission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['client_id', 'fbpermission_id'])

        # Changing field 'Client.fb_app'
        db.alter_column('clients', 'fb_app_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['targetshare.FBApp']))
