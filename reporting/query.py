METRICS = [
    ...
    ('failed_visits', 'Abandoned Visits', '# of visits that resulted in either the authorization being refused or the visit being abandoned (e.g., the browser window was closed)'),
    ('uniq_users_authorized', 'Unique Authorized Visitors', '# of unique visitors with one or more authorized visits'),
    ('visits_shown_faces', 'Visits Shown Suggestions', '# of visits that resulted in a user being shown friend suggestions'),
