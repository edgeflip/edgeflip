...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        """Initiate migrations for Facebook Apps:

            * Create FBApp table
            * create FBApp permissions table
            * move old Client.fb_app_id column aside (for data migration)
            * add new Client.fb_app_id column (for foreign key)
        ...
        # Adding M2M table for field permissions on 'FBApp'
        m2m_table_name = db.shorten_name('fb_apps_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fbapp', models.ForeignKey(orm['targetshare.fbapp'], null=False)),
            ('fbpermission', models.ForeignKey(orm['targetshare.fbpermission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fbapp_id', 'fbpermission_id'])

        # Renaming column for 'Client.fb_app_id' to match new field type.
        db.rename_column('clients', 'fb_app_id', '_fb_app_id')
        # Changing field 'Client.fb_app_id'
        db.alter_column('clients', '_fb_app_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='_fb_app_id'))

        # Adding field 'Client.fb_app'
        db.add_column('clients', 'fb_app',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='clients', null=True, to=orm['targetshare.FBApp']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field permissions on 'FBApp'
        db.delete_table(db.shorten_name('fb_apps_permissions'))

        # Deleting field 'Client.fb_app'
        db.delete_column('clients', 'fb_app_id')

        # Renaming column for 'Client.fb_app_id' to match new field type.
        db.rename_column('clients', '_fb_app_id', 'fb_app_id')
        # Changing field 'Client.fb_app_id'
        db.alter_column('clients', 'fb_app_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    models = {
        ...
        'targetshare.client': {
            ...
            'fb_app': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'clients'", 'null': 'True', 'to': "orm['targetshare.FBApp']"}),
            'fb_app_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'db_column': "'_fb_app_id'", 'blank': 'True'}),
            'fb_app_name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'fb_app_permissions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['targetshare.FBPermission']", 'symmetrical': 'False', 'blank': 'True'}),
