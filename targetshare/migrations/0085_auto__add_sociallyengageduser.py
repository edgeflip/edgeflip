...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SociallyEngagedUser'
        db.create_table('socially_engaged_users', (
            ('fbid', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True)),
            ('birthday', self.gf('django.db.models.fields.DateField')(db_index=True)),
        ...
        db.send_create_signal('targetshare', ['SociallyEngagedUser'])


    def backwards(self, orm):
        # Deleting model 'SociallyEngagedUser'
        db.delete_table('socially_engaged_users')
    ...
    models = {
        ...
        'targetshare.sociallyengageduser': {
            'Meta': {'object_name': 'SociallyEngagedUser', 'db_table': "'socially_engaged_users'"},
            'birthday': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
