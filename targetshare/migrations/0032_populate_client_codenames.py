...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Populate Client.codename from subdomain or name."""
        for client in orm.Client.objects.all():
            if not client.subdomain or client.subdomain == 'app':
                client.codename = text.slugify(client.name)
            else:
                client.codename = client.subdomain
            client.save()

    def backwards(self, orm):
        """Clear Client.codename."""
        orm.Client.objects.update(codename='')
    ...
    models = {
        ...
        'targetshare.client': {
            ...
            'codename': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '50'}),
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
