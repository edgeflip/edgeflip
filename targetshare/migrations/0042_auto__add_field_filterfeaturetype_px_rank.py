...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterFeatureType.px_rank'
        db.add_column('filter_feature_types', 'px_rank',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3))

    def backwards(self, orm):
        # Deleting field 'FilterFeatureType.px_rank'
        db.delete_column('filter_feature_types', 'px_rank')
