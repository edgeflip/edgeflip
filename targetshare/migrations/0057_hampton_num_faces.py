...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """CampaignProperties.num_faces defaults to 9, but is 10 for Hampton campaigns."""
        orm.CampaignProperties.objects.filter(campaign__client__codename='hampton').update(num_faces=10)

    def backwards(self, orm):
        """Revert Hampton campaign properties' num_faces to 9."""
        orm.CampaignProperties.objects.filter(campaign__client__codename='hampton').update(num_faces=9)
