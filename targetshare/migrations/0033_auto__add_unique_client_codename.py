...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Client', fields ['codename']
        db.create_unique('clients', ['codename'])


    def backwards(self, orm):
        # Removing unique constraint on 'Client', fields ['codename']
        db.delete_unique('clients', ['codename'])
