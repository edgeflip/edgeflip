...
def extendTokenFb(token):
	url = 'https://graph.facebook.com/oauth/access_token?grant_type=fb_exchange_token&client_id=' + config['app_id'] + '&client_secret=' + config['app_secret'] + '&fb_exchange_token=' + token
