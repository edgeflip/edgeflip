...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events', 'type', self.gf('django.db.models.fields.CharField')(max_length=64, db_column='type'))

    def backwards(self, orm):

        # Changing field 'Event.event_type'
        db.alter_column('events', 'type', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, db_column='type'))
