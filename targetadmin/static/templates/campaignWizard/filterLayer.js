...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</span><button data-js=\"addFallbackBtn\" type=\"button\" class=\"btn\">Add Fallback Audience</button>        ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.removeBtn), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
