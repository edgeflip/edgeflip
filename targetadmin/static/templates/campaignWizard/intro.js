...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<section class=\"col-sm-10 campaign-wizard-intro\"><h1 class=\"heading\">Create A Targeted Sharing Campaign</h1><hr class=\"heading-separator\"><div class=\"row subheader\"><div class=\"col-sm-8\"><span>A targeted sharing campaign turns your supporters into influencers by asking them to share your content with friends who are likely to support your organization. </span><a href=\"";
  ...
  buffer += escapeExpression(stack1)
    + "\"></div><div class=\"wizard-step-description\"><div class=\"title\">Facebook Post</div><div>Finally, you'll create the Facebook post that your target audience will see. Clicking on this post will send users to your campaign content.</div></div></div></div>";
  return buffer;
  })
