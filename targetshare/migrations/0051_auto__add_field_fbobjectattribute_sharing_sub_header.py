...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FBObjectAttribute.sharing_sub_header'
        db.add_column('fb_object_attributes', 'sharing_sub_header',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2096, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FBObjectAttribute.sharing_sub_header'
        db.delete_column('fb_object_attributes', 'sharing_sub_header')
