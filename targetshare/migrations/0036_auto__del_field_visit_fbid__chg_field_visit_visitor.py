...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Visit.fbid'
        db.delete_column('visits', 'fbid')

        # Changing field 'Visit.visitor'
        db.alter_column('visits', 'visitor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.Visitor']))

    def backwards(self, orm):
        # Adding field 'Visit.fbid'
        db.add_column('visits', 'fbid',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Changing field 'Visit.visitor'
        db.alter_column('visits', 'visitor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targetshare.Visitor'], null=True))
    ...
    models = {
        ...
        'targetshare.visit': {
            ...
            'visitor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['targetshare.Visitor']"})
        },
        'targetshare.visitor': {
